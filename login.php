<?php
include "include/core_login.php";
        ...
        <div class="d-flex">
            ...
            <div class="main">
                ...
                <main class="content">
                    ...
                    <div class="container-fluid padding-card-login">

                        <div class="row">

                            <div class="col-sm-6 col-md-7 col-lg-8 col-xl-9 hidden-sm hidden-xs">
                                <img src="images/tool-145375__480.png" class="img-fluid">
                            </div>
                            <div class="col-sm-12 col-md-5 col-lg-6 col-xl-3">


                                <div class="card card-credent">
                                    <div class="content text-label">
                                        ...
                                        <form class="needs-validation" action="#" method="POST" novalidate="">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="username1" id="username" placeholder="Enter your Username" value="" required />
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="password" class="form-control" name="password1" id="passsword" placeholder="Enter your Password" value="" required />
                                                <div class="invalid-feedback">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <a href="resetPassword.php"><span class="text-login">Reset Password</span></a>
                                            </div>
                                            <div class="col-md-12">
                                                <hr />
                                            </div>
                                            <div class="text-center">
                                                <button class="btn btn-lg btn-outline-danger btn-half" name="login1" type="submit">Login</button>
                                            </div>
                                        </form>
