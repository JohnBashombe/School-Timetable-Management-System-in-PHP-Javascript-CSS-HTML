...
$sql = "SELECT * FROM room WHERE room_id = '$_id'";
...
if (isset($_POST['update_r'])) {
    ...
    $rn = test_input($_POST['room_name']);

    if (count($errors) == 0) {
        $update_room = "UPDATE room SET room_name = '$rn' WHERE room_id = '$_id' ";
                                                ...
                                                <form class="needs-validation" novalidate="" action="#" method="POST">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-3">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="text" class="form-control" placeholder="Room Name" name="room_name" value="<?php echo $row['room_name']; ?>" required>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
                                                            <hr />
                                                            <button type="submit" name="update_r" class="btn btn-sm btn-outline-primary btn-fifty">
