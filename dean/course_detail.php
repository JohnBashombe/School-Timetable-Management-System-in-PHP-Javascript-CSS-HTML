...
if (isset($_REQUEST['action'])) {
    ...
    switch ($action) {
        case 'deletecourse':
            $_id = $_REQUEST['id'];
            // archive_user($con, $id);
            $sql = "DELETE FROM course WHERE course_id = '$_id'";
                                            ...
                                            <div class="col-md-12 col-lg-12">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 col-sm-7 col-md-8 col-lg-9 col-xl-9">
                                                        <p class="text-muted title-small">
                                                            Course Code : <span class="pull-right"> <?php echo $row['course_code']; ?> </span>
                                                        </p>
                                                        <hr />
                                                        <p class="text-muted title-small">
                                                            Course Name : <span class="pull-right"> <?php echo $row['course_name']; ?> </span>
                                                        </p>
                                                        <hr />
                                                        <p class="text-muted title-small">
                                                            Lecturer : <span class="pull-right"> <?php echo $row['lecturer']; ?> </span>
                                                        </p>
                                                        <hr />
                                                        <p class="text-muted title-small">
                                                            Course Unit : <span class="pull-right"> <?php echo $row['course_unit']; ?> </span>
                                                        </p>
                                                        <hr />
                                                        <p class="text-muted title-small">
                                                        ...
                                                        <hr />
                                                        <p class="text-muted title-small">
                                                            Semester : <span class="pull-right"><?php echo $row['semester']; ?></span>
                                                        </p>
                                                    </div>
                                                    <?php  ?>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-6 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                                                        <a href="?action=deletecourse&id=<?php echo $row['course_id']; ?>" class="btn btn-sm btn-outline-danger">
                                                            <i class="nc-icon nc-scissors"></i> Remove User</a>
                                                    </div>
                                                    <div class="col-6 col-sm-6 col-md-6 col-lg-6 col-xl-">
                                                        <a href="?action=editcourse&id=<?php echo $row['course_id']; ?>"><button class="btn btn-sm btn-outline-primary pull-right">
                                                                <i class="nc-icon nc-ruler-pencil"></i> Edit User</button></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
