...
$_user = $_SESSION['user_login'];

$errors = array();

$sql = "SELECT * FROM user WHERE username = '$_user'";
...
if (isset($_POST['update_p'])) {
    ...
    if (count($errors) == 0) {
        $update_user = "UPDATE user SET firstname = '$fn', lastname = '$ln', phone = '$pn', email = '$em', username = '$username_user', password ='$pswd' WHERE username = '$_user' ";
        if (mysqli_query($con, $update_user)) {
            $_SESSION['user_login'] = $username_user;
                                                ...
                                                <form class="needs-validation" novalidate="" action="#" method="POST">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
                                                            <hr />
                                                            <button type="submit" name="update_p" class="btn btn-sm btn-outline-primary btn-fifty">
