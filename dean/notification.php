                                                ...
                                                <div class="row">
                                                    <div class="col-md-12 col-lg-5">
                                                        <p class="title text-muted">
                                                            <i class="nc-icon nc-email-85"></i>Messages</p>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <hr />
                                                    </div>
                                                    <div class="col-md-12">
                                                        <p class="text-muted title-small text-left">
                                                            <small>Ntavigwa Bash.</small> &nbsp;<small><small>17/080/BSCS-S</small></small><br />
                                                            <small><small><small>15/05/2019 13:00 AM</small></small></p>
                                                        <hr />
                                                        <p class="text-muted text-min text-justify">
