<?php
include "../include/user_manip.php";
                                                                                                    ...
                                                                                                    <tbody>
                                                                                                        ...
                                                                                                        <?php while ($row1 = mysqli_fetch_assoc($result1)) : ?>
                                                                                                            ...
                                                                                                            <tr>
                                                                                                                ...
                                                                                                                <td><a href="?action=detail&id=<?php echo $row1['user_id']; ?>"><button class="btn btn-sm btn-outline-primary btn-table">Full Details</button></a></td>
                                                                                                            </tr>
                                                                                                        <?php endwhile; ?>
                                                                                                    </tbody>
                                                                                                </table>
                                                                            ...
                                                                            <form class="needs-validation" action="#" method="POST" novalidate="">
                                                                                <div class="row text-left">
                                                                                                ...
                                                                                                <div class="row">
                                                                                                    ...
                                                                                                    <div class="col-md-6">
                                                                                                        <div class="form-group">
                                                                                                            ...
                                                                                                            <Select class="custom-select" required name="position">
                                                                                    ...
                                                                                    <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
                                                                                        <hr />
                                                                                        <button type="submit" name="add_user" class="btn btn-sm btn-outline-secondary btn-fifty">
                                                                                                    ...
                                                                                                    <tbody>
                                                                                                        <?php while ($row1 = mysqli_fetch_assoc($result)) : ?>
                                                                                                            <tr>
                                                                                                                ...
                                                                                                                <td> <?php echo $row1['email']; ?> </td>
                                                                                                                <td> <?php echo $row1['position']; ?> </td>
                                                                                                                <td><a href="?action=deleteuser&id=<?php echo $row1['user_id']; ?>"><button class="btn btn-sm btn-outline-danger btn-table">Delete</button></a></td>
                                                                                                            </tr>
