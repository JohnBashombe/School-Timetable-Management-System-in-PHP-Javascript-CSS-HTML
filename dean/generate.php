                                                            ...
                                                            <div class="col-md-12 col-lg-12">
                                                                ...
                                                                <div class="d-flex justify-content-center con">
                                                                    <ul class="nav bg-light" role="tablist">
                                                                        <li class="nav-item">
                                                                            <a href="#step-1" id="step1-tab" class="nav-link active" aria-selected="true" data-toggle="tab" role="tab"><span>Year I</span></a>
                                                                        </li>
                                                                        <li class="nav-item">
                                                                            <a href="#step-2" id="step2-tab" class="nav-link" aria-selected="false" data-toggle="tab" role="tab"><span>Year 2</span></a>
                                                                        </li>
                                                                        <li class="nav-item">
                                                                            <a href="#step-3" id="step3-tab" class="nav-link" aria-selected="false" data-toggle="tab" role="tab"><span>Year 3</span></a>
                                                                        </li>
                                                                        <li class="nav-item">
                                                                            <a href="#step-4" id="step4-tab" class="nav-link" aria-selected="false" data-toggle="tab" role="tab"><span>Year 4</span></a>
                                                                        </li>
                                                                                ...
                                                                                <div class="row">
                                                                                    <div class="col-md-12 col-lg-12">
                                                                                        ...
                                                                                        <p class="text-muted"><small>
                                                                                                Generate time tables for all semesters in Year I</small></p>
                                                                                        <hr />
                                                                                        <p><a href="../Main/year.html"><button class="btn btn-outline-secondary">Generate Time Table</button></a></p>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                            ...
                                                                            <div class="content">
                                                                                <div class="row">
                                                                                    <div class="col-md-12 col-lg-12">
                                                                                        ...
                                                                                        <hr />
                                                                                        <p class="text-muted"><small>
                                                                                                Generate time tables for all semesters in Year II</small></p>
                                                                                        <hr />
                                                                                        <p><a href="../Main/year.html"><button class="btn btn-outline-secondary">Generate Time Table</button></a></p>
                                                                                    </div>
                                                                                </div>
                                                                            ...
                                                                            <div class="content">
                                                                                <div class="row">
                                                                                    <div class="col-md-12 col-lg-12">
                                                                                        ...
                                                                                        <hr />
                                                                                        <p class="text-muted"><small>
                                                                                                Generate time tables for all semesters in Year III</small></p>
                                                                                        <hr />
                                                                                        <p><a href="../Main/year.html"><button class="btn btn-outline-secondary">Generate Time Table</button></a></p>
                                                                                    </div>
                                                                                </div>
                                                                            ...
                                                                            <div class="content">
                                                                                <div class="row">
                                                                                    <div class="col-md-12 col-lg-12">
                                                                                        ...
                                                                                        <hr />
                                                                                        <p class="text-muted"><small>
                                                                                                Generate time tables for all semesters in Year IV</small></p>
                                                                                        <hr />
                                                                                        <p><a href="year.html"><button class="btn btn-outline-secondary">Generate Time Table</button></a></p>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
