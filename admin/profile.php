...
$_user = $_SESSION['admin_login'];

$errors = array();

$sql = "SELECT * FROM admin WHERE username = '$_user'";
...
if (isset($_POST['update_admin'])) {
    ...
    $username_user = test_input($_POST['username']);;

    if (count($errors) == 0) {
        $update_user = "UPDATE admin SET firstname = '$fn', lastname = '$ln', phone = '$pn', email = '$em', username = '$username_user', password ='$pswd' WHERE username = '$_user' ";
        if (mysqli_query($con, $update_user)) {
            $_SESSION['admin_login'] = $username_user;
            header('location: admin.php');
        } else {
            array_push($errors, "Not Updated" . mysqli_connect_error($con));
        }
    }
}
                                                ...
                                                <form class="needs-validation" novalidate="" action="#" method="POST">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-6">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="phone" class="form-control" name="phone" placeholder="Phone Number" value="<?php echo $row['phone']; ?>" required>
                                                                                <div class="invalid-feedback">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-6">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="text" class="form-control" name="password" placeholder="Password" value="<?php echo $row['password']; ?>" required>
                                                                                <div class="invalid-feedback">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="text" class="form-control" name="cpassword" placeholder="Confirm Password" value="<?php echo $row['password']; ?>" required="">
                                                                                <div class="invalid-feedback">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
                                                            <hr />
                                                            <button type="submit" name="update_admin" class="btn btn-sm btn-outline-primary btn-fifty">
